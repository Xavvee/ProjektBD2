...
from .views import create_client, create_dish, create_game, create_employee, find_client, delete_client, find_dish, \
    ...
    find_client_reservations, find_future_client_reservations, find_past_client_reservations, \
    find_reservation_with_status, update_employee, find_all_clients, find_all_games, find_all_employees, \
    find_all_dishes, create_reservation, check_if_free_date, display_tables_for_game, show_clients_ordered_dishes, \
    calculate_recipe, add_table_to_game, update_reservation, filter_menu_by_dish_type
