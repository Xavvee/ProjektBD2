...
from .views import create_client, create_dish, create_game, create_employee, find_client, delete_client, find_dish, \
    ...
    find_future_client_reservations, find_past_client_reservations, find_reservation_by_param, \
...
urlpatterns = [
    ...
    path('find_reservation_by_param/', find_reservation_by_param, name='find_reservation_by_param'),
